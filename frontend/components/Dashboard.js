    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.rowContainer}>
          ...
          <Pressable onPress={() => props.navigation.navigate("ListOffers")} style={styles.shadowContainer}>
            <View style={styles.itemContainer}>
            <View style={[styles.topRight, styles.infoColor]}><Text style={styles.infoText}>{jobOffersLength}</Text></View>
          ...
          <Pressable onPress={() => setScreenDisplay("MyLikes")} style={styles.shadowContainer}>
            <View style={styles.itemContainer}>
              <View style={[styles.topRight, styles.infoColor]}><Text style={styles.infoText}>{likedJobsLength}</Text></View>
        ...
        <View style={styles.rowContainer}>
          ...
          <Pressable onPress={() => setScreenDisplay("MyDocuments")} style={styles.shadowContainer}>
            <View style={styles.itemContainer}>
              <Ionicons 
          ...
          <Pressable onPress={() => setScreenDisplay("PersonalInfo")} style={styles.shadowContainer}>
            <View style={styles.itemContainer}>
              {!profileComplete && <View style={[styles.topRight, styles.warningColor]}><Text style={styles.warningText}>!</Text></View>}
              <MaterialCommunityIcons 
        ...
        <View style={styles.rowContainer}>
          ...
          <Pressable onPress={() => props.navigation.navigate("Skills")} style={styles.shadowContainer}>
            <View style={styles.itemContainer}>
              {jobSkillsIncomplete && <View style={[styles.topRight, styles.warningColor]}><Text style={styles.warningText}>!</Text></View>}
              <MaterialCommunityIcons
                name="lightning-bolt"
                size={60}
                color="#B9FFFF"
          ...
          <Pressable onPress={() => setScreenDisplay("MyMissions")} style={styles.shadowContainer}>
            <View style={styles.itemContainer}>
