  ...
  return (
    ...
    <Tab.Navigator
        screenOptions={({ route }) => ({
          tabBarIcon: ({ color, focused }) => {
            ...
            if (route.name === "Dashboard") {
              ...
              return <MaterialCommunityIcons name="text-box-search-outline" size={24} color={color} />
              // iconName = "ios-options";
            } else if (route.name === "Notification") {
              // iconName = "notifications-sharp";
              return <Ionicons  name={"notifications-sharp"} size={25} color={color} />;
              
            } else if (route.name === "Skills") {
              return <MaterialCommunityIcons name="lightning-bolt" size={24} color={color} />
        ...
        tabBarOptions={{
          ...
          style:{backgroundColor:'#001150',height:67,paddingBottom:8,borderWidth:3,borderColor:"#c3fbfb",borderRadius:40,
          borderTopWidth: 3,borderTopColor:"#c3fbfb",marginLeft:5,marginRight:5,marginBottom:10}
      ...
      >
        ...
        <Tab.Screen name="ListOffers" component={Notifications}/>
